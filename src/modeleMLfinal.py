...
x = np.array([item[0] for item in data_list])  # input : altitude, Mach, diameter
...
print(
    "The best result obtained was a RMSE of {best_result} with a learning rate of {best_learning_rate}")
